{
    ...
    4:{
        ...
        "course": 0,
        "description": "Generally building, deploying, maintaining, retraining, and optimize machine learning systems. Work with data scientists and domain experts to design the ML…",
        "salary": "5000",
    ...
    5:{
        ...
        "duration": "Internship",
        "company": "MS CONSULTANCY PTE. LTD.",
        "course": 0,
        "description": "The role of the Technical Artist is to bridge the gap between the issues of the creative, programming and engineer teams in game development.",
        "salary": "3000",
        "skills": ["Programming", "Docker", "python"],
        "industry": ["Gaming", "IT"],
    },

    6:{
        "title": "Site Reliability Engineer, AI/Machine Learning, Singapore",
        "duration": "Intern",
        "company": "JPMorgan Chase Bank, N.A.",
        "course": 0,
        "description": "As a Site Reliability Engineer (SRE) for OmniAI which is JPMC's firm wide AI/ML platform, you'll help build a meaningful engineering discipline, combining…",
        "salary": "4000",
        "skills": ["python", "machine learning", "coding"],
        "industry": ["Finance", "IT"],
    },
    ...
    7:{
        ...
        "duration": "Internship",
        "company":"SINGAPORE LIFE LTD.",
        "course": 0,
        "description": "We are looking for a Junior Quantitative Analyst where successful candidate will have a high impact adding necessary quantitative capabilities to the Investment…",
        "salary": "3000",
        "skills": ["python", "machine learning", "coding"],
        "industry": ["Finance", "IT"],
    },
    ...
    8:{
        ...
        "course": 0,
        "description": "Experience in implementing and operationalizing Cloud security solutions (IaaS, PaaS, and SaaS)",
        "salary": "6000",
        "skills": ["python", "machine learning", "coding", "cloud", "aws"],
        "industry": ["Security", "IT"],
    },

    9:{
        "title": "Sr. Staff Database Engineer",
        "duration": "Full-Time",
        "company": "Visa",
        "course": 0,
        "description": "It architects, builds and maintains secure and reliable data centers, systems and networks to support the business functionality that Visa provides to payment…",
        "salary": "6000",
        "skills": ["python", "machine learning", "coding", "database"],
        "industry": ["Finance", "IT"],
    },

    10:{
        "title": "Regional CRM Intern",
        "duration": "Internship",
        "company": "Shopee",
        "course": 0,
        "description": "The Marketing team at Shopee is responsible for conceptualising and implementing go-to-market activities to achieve increased usage and visibility.",
        "salary": "1800",
